...
winner_image = pygame.image.load("assets/winner.png")
winner_image = pygame.transform.scale(winner_image, (300, 150))
...
def draw_game_won(screen):
    ...
    win_rect = winner_image.get_rect(center=(screen_width // 2, screen_height // 2 - 80))
    screen.blit(winner_image, win_rect)

    font_pixel = _ui_assets["font_pixel_small"]
    message_lines = [
        "you did it! you're goated!",
